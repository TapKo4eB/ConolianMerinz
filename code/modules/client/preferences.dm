...
/datum/preferences
	...
	var/toggle_prefs = TOGGLE_MIDDLE_MOUSE_CLICK|TOGGLE_DIRECTIONAL_ATTACK|TOGGLE_MEMBER_PUBLIC|TOGGLE_COMBAT_CLICKDRAG_OVERRIDE // flags in #define/mode.dm
			...
			switch(href_list["preference"])
				...
				if("lobby_music")
					...
					if(toggles_sound & SOUND_LOBBY)
						user << sound(SSticker.login_music, wait = 0, volume = 85, channel = SOUND_CHANNEL_LOBBY)
					else
						user << sound(null, repeat = 0, wait = 0, volume = 85, channel = SOUND_CHANNEL_LOBBY)
